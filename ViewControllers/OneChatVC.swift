...
final class OneChatVC: MessagesViewController {
...
extension OneChatVC: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
...
extension OneChatVC: InputBarAccessoryViewDelegate {
    ...
    private func createMessageId() -> String? {
       ...
       // let dateString = Self.dateFormatter.string(from: Date())
        let newIdentifier = "\(otherUserEmail)_\(safeCurrentEmail)_\(uuid)"
...
extension OneChatVC: MessagesDataSource, MessagesLayoutDelegate, MessagesDisplayDelegate {
...
extension OneChatVC: MessageCellDelegate {
 ...
 /*    private var messages = [Message]()
    ...
    //Delegates stubs
    func currentSender() -> SenderType {
        return Sender(senderId: "1", displayName: "Self")
    }
